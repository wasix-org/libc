//! WASIX ([wasix-libc](https://github.com/wasix-org/wasix-libc)) definitions,
//! used by the `*-wasmer-wasi` targets. wasix-libc is a wasi-libc fork with
//! threads, signals, full sockets, process management and more.
//!
//! Definitions shared with plain wasi-libc live in the parent module; this
//! file only contains items that are WASIX specific or that differ from
//! upstream wasi-libc (whose versions live in `wasi.rs`).

use crate::prelude::*;

// wasix-libc (musl arch/wasm32) defines clockid_t as a plain int holding the
// raw wasi clock id, unlike wasi-libc's pointer-to-opaque-struct scheme.
...
pub type cc_t = crate::c_uchar;
pub type speed_t = crate::c_uint;
pub type tcflag_t = crate::c_uint;
...
pub const POSIX_SPAWN_USEVFORK: crate::c_int = 0x40;
pub const POSIX_SPAWN_SETSID: crate::c_int = 0x80;
...
extern "C" {
    ...
    pub fn __wasilibc_get_environ() -> *mut *mut crate::c_char;
    ...
    pub fn tcgetattr(fd: crate::c_int, termios: *mut crate::termios) -> crate::c_int;
    pub fn tcsetattr(fd: crate::c_int, optional_actions: crate::c_int, termios: *const crate::termios) -> crate::c_int;
